...
import { TrendingUp, TrendingDown, Target, Activity, Zap, Shield, BarChart2 } from 'lucide-react';
  ...
  return (
    <div className="card fade-in">
      ...
      <div className="sections-grid">
        ...
        {/* SECTION 2: Volatility & Risk */}
        <div>
          <h4 style={{ color: 'var(--text-secondary)', marginBottom: '0.25rem', marginTop: '0', fontSize: '0.85rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Volatility & Risk</h4>
          <div className="metrics-grid">
            <div className="metric">
        ...
        {/* SECTION 3: Liquidity & Smart Money */}
        <div>
          <h4 style={{ color: 'var(--text-secondary)', marginBottom: '0.25rem', marginTop: '0', fontSize: '0.85rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Liquidity & Volume</h4>
          <div className="metrics-grid">
            <div className="metric">
        ...
        {/* SECTION 4: Technicals & Oscillators */}
        <div>
        ...
        {/* SECTION 6: Algo Predictions */}
        <div>
          <h4 style={{ color: 'var(--text-secondary)', marginBottom: '0.25rem', marginTop: '0', fontSize: '0.85rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Algo Predictions</h4>
          <div className="metrics-grid">
            <div className="metric">
              <span className="metric-label">Algo Upside</span>
              <span className="metric-value" style={{ color: stock.algoUpside > 10 ? 'var(--success)' : 'inherit' }}>
